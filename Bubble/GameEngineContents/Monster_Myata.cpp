...
const std::string_view		Monster_Myata::RightImagePath			= "Right_Myata.bmp";
const std::string_view		Monster_Myata::LeftImagePath			= "Left_Myata.bmp";
const std::string_view		Monster_Myata::RightRageImagePath	= "Right_Myata_Rage.bmp";
const std::string_view		Monster_Myata::LeftRageImagePath	= "Left_Myata_Rage.bmp";
const std::string_view		Monster_Myata::LockImagePath			= "Myata_Lock.bmp";
const std::string_view		Monster_Myata::DeadImagePath			= "Myata_Dead.bmp";

Monster_Myata::Monster_Myata()
{
...
void Monster_Myata::Start()
{
	...
	MoveState->SetStateChangeFunc((StateChangeFuncPtr)&Monster_Myata::MoveToDash);
	...
	MonsterState_RigidDash* DashState = GetFSM()->CreateState<MonsterState_RigidDash>(MonsterStateType::RigidDash);
...
void Monster_Myata::ResourceLoad()
{
...
bool Monster_Myata::MoveToDash(float _DeltaTime)
{
	...
	{
		Timer -= DashTime;
		GetFSM()->ChangeState(MonsterStateType::RigidDash);
		return true;
	}
